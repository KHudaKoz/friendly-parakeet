...
function generateNewPassword() {
  var length = Number(prompt("Please select the desired charactor length for your new password.  Select a number between 8-128."));
  ...
  var numbers = confirm("Should numbers be included in your new password?  OK = YES, and CANCLE = NO.");
  var symbols = confirm("Should special characters be included in your new password? OK = YES, and CANCLE = NO.");
  var lowercaseletters = confirm("Should lowercase letters be included in your new password? OK = YES, and CANCLE = NO.");
  var uppercaseletters = confirm("Should UPPERCASE letters be included in your new password? OK = YES, and CANCLE = NO.");
  ...
  while (!uppercaseletters && !lowercaseletters && !numbers && !symbols) {
    ...
    numbers = confirm("Should numbers be included in your new password?  OK = YES, and CANCLE = NO.");
    symbols = confirm("Should special characters be included in your new password? OK = YES, and CANCLE = NO.");
    lowercaseletters = confirm("Should lowercase letters be included in your new password? OK = YES, and CANCLE = NO.");
    uppercaseletters = confirm("Should UPPERCASE letters be included in your new password? OK = YES, and CANCLE = NO.");
